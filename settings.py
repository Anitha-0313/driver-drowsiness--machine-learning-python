...
ROOT_URLCONF = 'driver_drowsiness_classification.urls'
...
WSGI_APPLICATION = 'driver_drowsiness_classification.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'driver_drowsiness_classification',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
